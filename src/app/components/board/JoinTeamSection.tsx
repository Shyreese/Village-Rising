  ...
  return (
    <section className="relative z-10 flex justify-center px-6 md:px-8 pb-16 md:pb-24">
      <div className="bg-[#f9fafb] rounded-[30px] px-8 py-7 max-w-[654px] w-full text-center">
        ...
        <Link
          to="/programs"
          className="inline-block bg-[#c6a646] hover:bg-[#b5953d] transition-colors text-white font-['Public_Sans',sans-serif] text-[16px] leading-[24px] px-8 py-3 rounded-[34px]"
        >
          View Opportunities
        </Link>
      </div>
