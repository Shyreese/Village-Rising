...
export function ProgramCard({
  ...
  const contentBlock = (
    <div className="flex flex-col justify-start py-4 lg:py-8">
      {/* Tag */}
      ...
      {features.length > 0 ? (
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#4a5565] text-[12px]" dangerouslySetInnerHTML={{ __html: feature.subtitle }}></p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mb-6 mt-4">
          <button
            ...
            className="w-full max-w-[320px] h-[56px] bg-[#c6a646] hover:bg-[#b5953d] active:bg-[#a58535] 
