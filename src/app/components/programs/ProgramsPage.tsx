...
/*       { title: "Scholarship Access", subtitle: "College funding assistance", icon: GraduationCap },
  ...
  },
  {
    ...
    header: "Our Branches interns graduate with:",
    image: imgWorkforce,
    imagePosition: "right" as const,
    bgColor: "#eff6ff",
    ...
    features: [
      ...
      { title: "Leadership Skills", subtitle: " Gained from leading projects and programs", icon: Briefcase },
      { title: "Self-Sufficiency", subtitle: "Understanding organizational priorities and remote work discipline", icon: Briefcase },
